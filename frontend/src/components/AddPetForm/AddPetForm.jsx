              ...
              >
                <label>
                  <Field
                    ...
                    name="status"
                    value="lost_found"
                    checked={status === statusFilters.lost_found}
                    onChange={() => setStatus(statusFilters.lost_found)}
                ...
                <label>
                  <Field
                    ...
                    name="status"
                    value="in_good_hands"
                    checked={status === statusFilters.for_free}
                    onChange={() => setStatus("in good hands")}
                    className={css.petStatus_radio}
                  />
                ...
                <label>
                  <Field
                    ...
                    name="status"
                    value="sell"
                    checked={status === statusFilters.sell}
                    onChange={() => setStatus(statusFilters.sell)}
                    className={css.petStatus_radio}
                  />
